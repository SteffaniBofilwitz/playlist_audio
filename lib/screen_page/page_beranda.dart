...
class _PageHomeState extends State<PageHome> {
  ...
  Future<ModelAudio> fetchAudio() async {
    final response = await http.get(Uri.parse('http://10.126.157.95/audioDB/audio.php'));
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              return Padding(
                ...
                child: ListTile(
                  leading: Image.network('http://10.126.157.95/audioDB/gambar/${filteredData[index].gambar}'),
                  title: Text(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          playAudio(filteredData[index].id, 'http://10.126.157.95/audioDB/audio/${filteredData[index].fileAudio}');
                        },
                      ),
                      IconButton(
                        icon: Icon(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: NetworkImage('http://10.126.157.95/audioDB/gambar/${album.gambar}'),
                fit: BoxFit.cover,
              ),
            ),
          ),
